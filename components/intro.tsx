    ...
    >
        ...
        <div className={"relative"}>
          ...
          >
            <Image
              ...
              priority={true}
              className={
                "h-24 w-24 rounded-full border-[0.35rem] border-white object-cover shadow-xl "
              }
            />
          </motion.div>
      ...
      >
        <Link
          href={"#contact"}
          className={
            "group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110" +
        ...
        >
          {locale === "en" ? "Contact me here" : "تواصل معي هنا"}
          <BsArrowRight
        ...
        <a
          ...
          download
        >
          {locale === "en" ? "Download CV" : "حمل السيرة الذاتية"}
          <HiDownload
        ...
        <a
          className={
            "bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full outline-none focus:scale-[1.15] hover:scale-110 hover:text-gray-950  active:scale-105 transition cursor-pointer border border-black/20 dark:bg-white/60 "
          }
          href="https://www.linkedin.com/in/imad-al-khawam-446a2b25a/"
          target={"_blank"}
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/IMADAK98"
          target={"_blank"}
        >
          <BsGithub />
        </a>
        ...
        <a
          ...
          href="https://wa.me/message/LDNHEXFGMDOIG1"
          target={"_blank"}
        >
          <BsWhatsapp />
        </a>
